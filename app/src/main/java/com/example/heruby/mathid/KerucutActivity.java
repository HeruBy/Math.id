...
public class KerucutActivity extends AppCompatActivity {
    ...
    public void hitungKerucut (View view){
        float r,t,hasil;
        EditText e1 = (EditText)findViewById(R.id.editKerucutR);
        EditText e2 = (EditText)findViewById(R.id.editKerucutTinggi);
        TextView t1 = (TextView)findViewById(R.id.hasilKerucut);
        r= Float.valueOf(Integer.parseInt(e1.getText().toString()));
        t= Float.valueOf(Integer.parseInt(e2.getText().toString()));
        hasil = (float) ((3.14 * r * r * t) / 3);
        t1.setText(Float.toString(hasil));
        display(hasil);
    }

    private void display(Float number){
        TextView hasilKerucut = (TextView)findViewById(R.id.hasilKerucut);
        hasilKerucut.setText(""+number);
