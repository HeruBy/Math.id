...
public class KaliActivity extends AppCompatActivity {
    ...
    public void hitungKali (View view){
        float n1,n2,hasil;
        EditText e1 = (EditText)findViewById(R.id.editKaliBil1);
        EditText e2 = (EditText)findViewById(R.id.editKaliBil2);
        TextView t1 = (TextView)findViewById(R.id.hasilKali);
    ...
    private void display(float number){
        TextView hasilJml = (TextView)findViewById(R.id.hasilKali);
