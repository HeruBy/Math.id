...
public class PenguranganActivity extends AppCompatActivity {
    ...
    public void hitungKurang (View view){
        float n1,n2,hasil;
        EditText e1 = (EditText)findViewById(R.id.editKrgBil1);
        EditText e2 = (EditText)findViewById(R.id.editKrgBil2);
        TextView t1 = (TextView)findViewById(R.id.hasilKrg);
    ...
    private void display(float number){
        TextView hasilKrg = (TextView)findViewById(R.id.hasilKrg);
        hasilKrg.setText(""+number);
