...
public class BelahKetupatActivity extends AppCompatActivity {
    ...
    public void hitungBelahKetupat (View view){
        float d1,d2,hasil;
        EditText e1 = (EditText)findViewById(R.id.editBKd1);
        EditText e2 = (EditText)findViewById(R.id.editBKd2);
        TextView t1 = (TextView)findViewById(R.id.hasilBelahKetupat);
    ...
    private void display(Float number){
        TextView hasilBelahKetupat = (TextView)findViewById(R.id.hasilBelahKetupat);
        hasilBelahKetupat.setText(""+number);
